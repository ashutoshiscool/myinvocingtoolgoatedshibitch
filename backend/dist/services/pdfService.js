...
function generateInvoicePDF(invoice, customer, company, items) {
    return new Promise((resolve, reject) => {
        ...
        doc
            ...
            .fontSize(10)
            .font('Helvetica-Bold')
            .text(`Invoice No: `, 350, 90, { continued: true, align: 'right' })
            .font('Helvetica')
            .text(invoice.invoice_number)
            .font('Helvetica-Bold')
            .text(`Issue Date: `, 350, 105, { continued: true, align: 'right' })
            .font('Helvetica')
            .text(invoice.issue_date)
            .font('Helvetica-Bold')
            .text(`Due Date: `, 350, 120, { continued: true, align: 'right' })
            .font('Helvetica')
